...
{
    public partial class BdgaccountGroupSubGroupSubGroup
    {
        public BdgaccountGroupSubGroupSubGroup()
        {
            BdgaccountGroupSubGroupSubGroupSubGroups = new HashSet<BdgaccountGroupSubGroupSubGroupSubGroup>();
            ...
            InverseParentBdgaccountGroupSubGroupSubGroup = new HashSet<BdgaccountGroupSubGroupSubGroup>();
        }
        ...
        public Guid? ParentBdgaccountGroupSubGroupSubGroupId { get; set; }
        ...
        public virtual BdgaccountGroupSubGroupSubGroup ParentBdgaccountGroupSubGroupSubGroup { get; set; }
        public virtual ICollection<BdgaccountGroupSubGroupSubGroupSubGroup> BdgaccountGroupSubGroupSubGroupSubGroups { get; set; }
        ...
        public virtual ICollection<BdgaccountGroupSubGroupSubGroup> InverseParentBdgaccountGroupSubGroupSubGroup { get; set; }
    }
}
