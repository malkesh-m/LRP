...
{
    public partial class CssBdgbudgetinfoDetailTempMissingItem
    {
        public string Tobedetermind { get; set; }
        public Guid? FrineobjectuiD { get; set; }
        public Guid BdgaccountgroupidHeader { get; set; }
