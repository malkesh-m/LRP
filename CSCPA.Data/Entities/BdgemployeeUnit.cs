...
{
    public partial class BdgemployeeUnit
    {
        public BdgemployeeUnit()
        {
            ...
            BdgemployeeUnitPositions = new HashSet<BdgemployeeUnitPosition>();
        ...
        public virtual Month EffectiveSalaryMonth { get; set; }
        ...
        public virtual ICollection<BdgemployeeUnitPosition> BdgemployeeUnitPositions { get; set; }
