...
{
    public partial class BdgbudgetInfo
    {
        public BdgbudgetInfo()
        {
            BdgbudgetInfoDetailBdgbudgetInfos = new HashSet<BdgbudgetInfoDetail>();
            BdgbudgetInfoDetailOldBdgbudgetInfos = new HashSet<BdgbudgetInfoDetail>();
            InversePreviousBdgbudgetInfo = new HashSet<BdgbudgetInfo>();
        }
        ...
        public virtual BdgreportType BdgreportType { get; set; }
        public virtual BdgbudgetInfo PreviousBdgbudgetInfo { get; set; }
        public virtual YearSetup YearSetup { get; set; }
        public virtual ICollection<BdgbudgetInfoDetail> BdgbudgetInfoDetailBdgbudgetInfos { get; set; }
        public virtual ICollection<BdgbudgetInfoDetail> BdgbudgetInfoDetailOldBdgbudgetInfos { get; set; }
        public virtual ICollection<BdgbudgetInfo> InversePreviousBdgbudgetInfo { get; set; }
    }
}
