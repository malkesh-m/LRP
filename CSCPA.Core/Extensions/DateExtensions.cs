...
namespace CSCPA.Core.Extensions
{
    public static class DateExtensions
    {
        public static IEnumerable<T> FillInEmptyDates<T>(IEnumerable<DateTime> allDates, IEnumerable<T> sourceData, Func<T, DateTime> dateSelector, Func<DateTime, T> defaultItemFactory)
        {
