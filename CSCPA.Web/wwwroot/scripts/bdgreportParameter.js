var bdgreportParameterList = {
    instance: function () {
        return $("#BdgreportParameterList").dxDataGrid("instance");
    },
    refreshList: function () {
        $("#BdgreportParameterList").dxDataGrid("instance").refresh();
    },
    ...
    onDeleteBtnClick: function () {
        ...
        swal({
            ...
            function (isConfirm) {
                if (isConfirm) {
                    let dataGrid = $("#BdgreportParameterList").dxDataGrid("instance");
    ...
    toolbar_preparing: function (e) {
        ...
        e.toolbarOptions.items.unshift({
            ...
            options: {
                icon: "plus",
                onClick: function (e) {
                    bdgreportParameterAddEdit.showModel(e, bdgreportParameterList.refreshList());
                }
            }
        }, {
            location: "after",
            ...
            options: {
                ...
                disabled: true,
                onClick: function (e) {
                    bdgreportParameterList.onDeleteBtnClick();
                }
            }
        });
    }
...
$(function () {
    $("#BdgreportParameterList > div > div.dx-datagrid-header-panel > div > div > div.dx-toolbar-after > div:nth-child(2) > div > div").attr("id", "Delete");
    common.getlastLayout("ReportList");
})

var bdgreportParameterAddEdit = {
    ...
    showModel: function (e, hideModelCallback) {
        ...
        $model.on("hidden.bs.modal", function (e) {
            if (hideModelCallback) {
                hideModelCallback(bdgreportParameterAddEdit.hideModelCallbackData);
                return;
            }
        });
        var $modelBody = $model.find(".modal-body");
        $modelBody.html("");
        $('.modal-title').text((e.row ? "Edit" : "Add") + " Bdg Report Parameter")
        $model.modal("show");
        ...
        if (validationResult.isValid) {
            $.ajax({
                ...
                complete: function () {
                    ...
                    bdgreportParameterList.refreshList();
                }
            });
        }
    }
